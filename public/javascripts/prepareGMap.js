...
function initMap() {
    return __awaiter(this, void 0, void 0, function () {
        var position, Map, AdvancedMarkerElement, commentString, contentString, infoWindows, markers;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    infoWindows = [];
                    markers = [];
                    DummyData.map(function (value) {
                        commentString = "";
                        value.sanpoComment.map(function (comment) {
